...
results = []
client = OpenAI(
    api_key="eyJ0eXBlIjoiSldUIiwiYWxnIjoiSFM1MTIifQ..YCQu4BZh4vydXMnJjyeOsVK1dkhns-NAesZ55KT02vKl9Z34qrrl7pteYyliy6zRpdhKuJ6YOGPpVkur_1qYHw",  # 此处传token，不带Bearer
...
jimmy大佬修改了`getdata.py`，我这边尝试使用老师给的。
![1733712510630](image/readme/1733712510630.png)
    ...
    def run(self):
        ...
        with ThreadPoolExecutor(max_workers=5) as pool:
            ...
            for future in tqdm(futures):
                ...
                if answer_queue.qsize() >= 5:  # 每10个问题保存一次
                    self.save([answer_queue.get() for _ in range(5)])
    ...
    def __call__(self):
        ...
        with ThreadPoolExecutor(max_workers=1) as pool:
            ...
            for future in tqdm(futures):
                result = future.result()
                answer_queue.put(result)
                if answer_queue.qsize() >= 5:  # 每5个问题保存一次
                    self.save([answer_queue.get() for _ in range(5)])
...
if __name__ == '__main__':
    questions_path = '/root/Tutorial//tools/L1_XTuner_code/Q_list.txt'
    save_path = '/root/Tutorial//data/train_basic.jsonl'
